    ...
    return (
        <>
            <div className="flex h-fit w-screen  flex-col bg-[#1E1E1E]">
                ...
                <div className="px-[10vw] mt-[5.5vw] sm:mt-[7.5vw]">
                ...
                <div className="w-full flex justify-center mt-[5.5vw]">
                    <div className="py-[1.5vw] px-[1.5vw] font-semibold text-[1.2vw] bg-[#4285F4] text-[#FFFFFF] ease-in-out duration-500  hover:shadow-[0px_0px_0.6vw_0.25vw_white]">
